...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-green text-white navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src="https://cdn2.vectorstock.com/i/thumb-large/12/31/bakery-bakeshop-logo-or-label-home-baking-bread-vector-21231231.jpg"
                width="110"
                height="32"
                alt="Tabler"
